...
{array[index].name = value; return array;}
console.log(updateKey(artists, 8, "name", "Vincent Van Gogh"));
...
console.log(addArtist(artists, 'meghan', '1986 - current', 'web development', 'bio'));
